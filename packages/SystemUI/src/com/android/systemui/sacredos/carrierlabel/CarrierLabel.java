...
package com.android.systemui.sacredos.carrierlabel;
...
import com.android.internal.util.sacredos.SACREDUtils;

import com.android.systemui.R;
import com.android.systemui.sacredos.carrierlabel.SpnOverride;
    ...
    private final BroadcastReceiver mIntentReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (TelephonyIntents.SPN_STRINGS_UPDATED_ACTION.equals(action)
                ...
                isCN = SACREDUtils.isChineseLanguage();
            }
        }
    };
